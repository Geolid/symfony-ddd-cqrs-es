...
**NEVER**
- Dispatch a Command whose only purpose is to make another BC react — persist through the Repository directly and let the real Domain Event fire; cross-BC fan-out (Policy, Reducer) then reacts exactly as it would outside a demo.
