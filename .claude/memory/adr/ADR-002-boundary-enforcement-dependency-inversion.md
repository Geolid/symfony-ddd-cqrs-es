...
be declared). phpat (a PHPStan extension under `tools/PHPat/`) enforces how a BC exposes that
interface.
...
- ALWAYS implement a cross-cutting port in the owning BC's Infrastructure.
