 ...
 * Domain Events. Domain Events themselves never leave their BC (see ADR-001) — an
 * Infrastructure-layer Translator converts them into Integration Events instead.
 */
