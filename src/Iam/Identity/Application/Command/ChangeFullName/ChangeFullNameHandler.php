...
namespace Iam\Identity\Application\Command\ChangeFullName;
...
#[CommandHandler]
final readonly class ChangeFullNameHandler
{
     ...
     */
    public function __invoke(ChangeFullName $command): void
    {
        $identity = $this->repository->load(IdentityId::fromString($command->id));
        $identity->changeFullName(FullName::fromString($command->fullName), $this->clock->now());
