...
namespace Iam\Authentication\Application\Command\EnrollTotpCredential\Exception;
...
final class TotpAlreadyEnrolledException extends \RuntimeException implements ApplicationExceptionInterface
{
    ...
    {
        return new self(
            message: \sprintf('Identity "%s" already has a TOTP credential enrolled.', $identityId),
            previous: $previous,
        );
    }
}
