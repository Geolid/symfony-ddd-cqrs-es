...
namespace Iam\Authentication\Infrastructure\Persistence\EventStore\Repository;
...
final readonly class ApiKeyCredentialRepository implements ApiKeyCredentialRepositoryInterface
{
    /**
