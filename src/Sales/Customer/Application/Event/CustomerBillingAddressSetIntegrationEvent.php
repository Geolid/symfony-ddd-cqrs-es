...
#[Event('sales.customer.integration.billing_address_set')]
final readonly class CustomerBillingAddressSetIntegrationEvent implements IntegrationEventInterface
{
    /**
