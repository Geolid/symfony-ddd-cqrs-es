...
#[Event('integration.sales.buyer.buyer.billing_address_defined')]
final readonly class BuyerBillingAddressDefinedIntegrationEvent implements IntegrationEventInterface
{
    /**
