...
#[Projector('sales.order.order_lines')]
final readonly class DbalOrderLineProjector extends AbstractDbalProjector
{
    public const string TABLE = 'sales_order_line';
    ...
    protected function configureSchema(Schema $schema): void
    {
        ...
        $table->addIndex(['order_id'], 'sales_order_line_order_id_idx');
    }
}
