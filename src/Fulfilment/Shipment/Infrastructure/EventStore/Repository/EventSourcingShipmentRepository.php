...
namespace Fulfilment\Shipment\Infrastructure\EventStore\Repository;
...
final readonly class EventSourcingShipmentRepository implements ShipmentRepositoryInterface
{
    /**
