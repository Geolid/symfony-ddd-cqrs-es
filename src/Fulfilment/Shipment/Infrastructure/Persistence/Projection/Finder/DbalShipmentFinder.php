 ...
 *
 * @phpstan-type Row array{id: string, order_id: string, status: string, tracking_reference: string|null, created_at: string, dispatched_at: string|null, delivered_at: string|null, cancelled_at: string|null}
 */
final class DbalShipmentFinder extends AbstractDbalCollectionFinder implements ShipmentFinderInterface
{
    ...
    {
        $qb->select('id', 'order_id', 'status', 'tracking_reference', 'created_at', 'dispatched_at', 'delivered_at', 'cancelled_at')
