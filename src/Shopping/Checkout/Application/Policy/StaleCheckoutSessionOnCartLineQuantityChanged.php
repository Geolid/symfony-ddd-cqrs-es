...
#[Policy('shopping.checkout.stale_checkout_session_on_cart_line_quantity_changed')]
final readonly class StaleCheckoutSessionOnCartLineQuantityChanged
{
    ...
    public function __invoke(CartLineQuantityChanged $event): void
    {
