...
#[Event('integration.shopping.checkout.shopper.billing_address_defined')]
final readonly class ShopperBillingAddressDefinedIntegrationEvent implements IntegrationEventInterface
{
    /**
