...
#[Event('integration.shopping.checkout.shopper.shipping_address_defined')]
final readonly class ShopperShippingAddressDefinedIntegrationEvent implements IntegrationEventInterface
{
    /**
