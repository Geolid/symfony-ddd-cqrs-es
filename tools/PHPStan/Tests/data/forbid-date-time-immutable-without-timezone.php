...
new DateTimeImmutable($row['value'], new DateTimeZone('UTC')); // allowed: explicit timezone argument
...
new DateTimeImmutable($row['value']); // forbidden: rehydrating a database column with no explicit timezone argument
