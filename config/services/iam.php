...
return static function (ContainerConfigurator $container): void {
    ...
    if ('test' === $container->env()) {
        // These #[AsDrivingPort] ports (plus the user_checker/voter wired into a firewall) are
        // only ever consumed by a DM's own Authenticator/security.php (apps/web, apps/api) — a
        // bare BC-level test container has no such consumer, so the compiler would otherwise
