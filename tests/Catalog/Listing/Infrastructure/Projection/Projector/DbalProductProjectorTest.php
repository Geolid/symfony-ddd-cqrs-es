...
/**
 * @phpstan-type Row array{label: string, unit_price_in_cents: int, listed_at: string, repriced_at: string|null}
 */
final class DbalProductProjectorTest extends AbstractIntegrationTestCase
{
    ...
    private function fetchRow(string $id): array|false
    {
        ...
        return $connection->fetchAssociative(
            \sprintf('SELECT label, unit_price_in_cents, listed_at, repriced_at FROM %s WHERE id = :id', DbalProductProjector::TABLE),
            ['id' => $id],
        );
    }
}
