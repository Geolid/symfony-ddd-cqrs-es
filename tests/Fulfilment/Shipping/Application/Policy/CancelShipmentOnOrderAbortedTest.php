...
use Fulfilment\Shipping\Application\Policy\CancelShipmentOnOrderAborted;
...
final class CancelShipmentOnOrderAbortedTest extends AbstractIntegrationTestCase
{
    #[Test]
    public function itCancels(): void
    {
        ...
        // When
        $this->trigger(CancelShipmentOnOrderAborted::class, new OrderAbortedIntegrationEvent($orderId, Uuid::uuid7()->toString(), Clock::get()->now()));
    }
}
