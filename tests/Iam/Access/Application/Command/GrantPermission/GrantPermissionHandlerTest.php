...
{
    private GrantFinderInterface $grantFinder;

    protected function setUp(): void
    {
        parent::setUp();

        $this->grantFinder = $this->service(GrantFinderInterface::class);
    }
    ...
    public function itReactivatesARevokedGrantWhenGrantedAgain(): void
    {
        // Given
        $identityId = Uuid::uuid7()->toString();
        $grant = GrantTestFactory::new()->withIdentityId($identityId)->withPermission('fixture.widget:read')->revoked()->store();
