...
use Iam\Identity\Application\Policy\IssueEmailConfirmationOnIdentityRegistered;
...
final class IssueEmailConfirmationOnIdentityRegisteredTest extends AbstractIntegrationTestCase
{
    ...
    public function itNotifies(): void
    {
        ...
        // When
        $this->trigger(IssueEmailConfirmationOnIdentityRegistered::class, new IdentityRegistered($id, $fullName, $email, $registeredAt));
