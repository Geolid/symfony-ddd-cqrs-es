...
use Iam\Identity\Application\Policy\IssueEmailConfirmationOnIdentityEmailConfirmationRequested;
...
final class IssueEmailConfirmationOnIdentityEmailConfirmationRequestedTest extends AbstractIntegrationTestCase
{
    ...
    public function itNotifies(): void
    {
        ...
        // When
        $this->trigger(
            IssueEmailConfirmationOnIdentityEmailConfirmationRequested::class,
            new IdentityEmailConfirmationRequested($identity->id, Clock::get()->now()),
        );
