...
final class ValidPasswordTest extends CompoundConstraintTestCase
{
    ...
    {
        yield 'empty string' => ['', [self::notBlank(), self::length(), self::passwordStrength()]];
    ...
    protected function createValidator(): ValidatorInterface
    {
        ...
        return Validation::createValidatorBuilder()
            ->setConstraintValidatorFactory(new ConstraintValidatorFactory([
                NotCompromisedPasswordValidator::class => new NotCompromisedPasswordValidator(enabled: false),
            ]))
            ->getValidator();
    }
    ...
    {
        return new Assert\Length(min: 12, max: 4096);
    }
