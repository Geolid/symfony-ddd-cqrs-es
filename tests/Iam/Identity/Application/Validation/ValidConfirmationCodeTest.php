...
/**
 * @extends CompoundConstraintTestCase<ValidConfirmationCode>
 */
final class ValidConfirmationCodeTest extends CompoundConstraintTestCase
{
    #[Test]
    ...
    protected function createCompound(): ValidConfirmationCode
    {
        return new ValidConfirmationCode();
    }
}
