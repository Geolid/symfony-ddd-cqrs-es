...
namespace Shared\Tests\Infrastructure\Persistence\EventStore\Appender;
...
final class IntegrationEventAppenderTest extends TestCase
{
    ...
    public function itPublishes(): void
    {
        ...
        // When
        $this->appender->publish(FakeAggregate::class, $id, $event);
    ...
    public function itThrowsWhenNotStreamAware(): void
    {
        ...
        // When
        $this->appender->publish(\stdClass::class, Uuid::uuid7()->toString(), new DummyIntegrationEvent());
    }
}
