...
use Shopping\Checkout\Infrastructure\CipherKey\DropCheckoutSessionCipherKeyOnShopperErased;
use Shopping\Tests\Checkout\Support\Builder\CheckoutSessionBuilder;
use Support\TestCase\AbstractIntegrationTestCase;
use Symfony\Component\Clock\Clock;

final class DropCheckoutSessionCipherKeyOnShopperErasedTest extends AbstractIntegrationTestCase
{
    ...
    public function itDrops(): void
    {
        ...
        $firstAttempt = CheckoutSessionBuilder::new()->withShopperId($shopperId)->staled()->create();
        $secondAttempt = CheckoutSessionBuilder::new()->withShopperId($shopperId)->create();
        ...
        // When
        $this->trigger(DropCheckoutSessionCipherKeyOnShopperErased::class, new ShopperErased($shopperId, $now));
