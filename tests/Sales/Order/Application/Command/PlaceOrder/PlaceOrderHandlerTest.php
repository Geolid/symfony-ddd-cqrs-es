...
final class PlaceOrderHandlerTest extends AbstractIntegrationTestCase
{
    ...
    public function itFailsWhenBuyerAddressesNotCompleted(bool $withShippingAddress, bool $withBillingAddress): void
    {
        ...
        if ($withShippingAddress) {
            $customer = $customer->registeredShippingAddress(PostalAddress::of(FullName::of('Ada', 'Lovelace'), Address::of('12 rue des Lilas', '75001', 'Paris', 'FR')));
        }
        if ($withBillingAddress) {
            $customer = $customer->registeredBillingAddress(PostalAddress::of(FullName::of('Ada', 'Lovelace'), Address::of('8 avenue Foch', '75116', 'Paris', 'FR')));
        }
