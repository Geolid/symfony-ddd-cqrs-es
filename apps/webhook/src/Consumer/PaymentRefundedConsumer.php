...
#[AsRemoteEventConsumer(PaymentRefundedParser::EVENT_TYPE)]
final readonly class PaymentRefundedConsumer implements ConsumerInterface
{
    ...
    public function consume(RemoteEvent $event): void
    {
        ...
        $this->commandBus->dispatch(new ConfirmOrderPaymentRefund($orderPayment->id));
    }
}
