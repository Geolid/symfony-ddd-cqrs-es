...
/**
 * @extends AbstractSignedRequestParser<PaymentFailedPayload>
 */
final class PaymentFailedParser extends AbstractSignedRequestParser
{
    public const string EVENT_TYPE = 'payment-failed';
