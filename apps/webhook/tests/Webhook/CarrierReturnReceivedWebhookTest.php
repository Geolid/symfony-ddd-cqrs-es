...
final class CarrierReturnReceivedWebhookTest extends AbstractWebhookTestCase
{
    ...
    public function itAcceptsACarrierReturnReception(): void
    {
        ...
        $shipment = ShipmentTestFactory::new()->prepared()->manifested()->dispatched()->delivered()
            ->returnRequested()->returnManifested(self::RETURN_TRACKING_REFERENCE)->returnDispatched()->store();
    ...
    public function itRejectsAnUnsignedReturnReception(?string $signature): void
    {
        // Given
        $client = self::createClient();
        $body = self::body(self::RETURN_TRACKING_REFERENCE);
    ...
    public function itFailsToAcceptAMalformedReturnReception(string $body): void
    {
        // Given
        $client = self::createClient();
    ...
    #[Test]
    public function itFailsToAcceptAnUntrackedReturnReception(): void
    {
        // Given
        $client = self::createClient();
