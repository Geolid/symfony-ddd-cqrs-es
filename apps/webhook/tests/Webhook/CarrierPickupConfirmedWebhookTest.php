...
final class CarrierPickupConfirmedWebhookTest extends AbstractWebhookTestCase
{
    ...
    public function itAcceptsACarrierPickupConfirmation(): void
    {
        ...
        $shipmentFactory = ShipmentTestFactory::new()->prepared()->manifested();
        ...
        self::assertSame(ShipmentStatus::DISPATCHED, $this->service(ShipmentFinderInterface::class)->ofId($shipment->id->toString())->status);
    }
