...
final class CarrierDeliveryOpenApiDocumentationTest extends AbstractWebhookOpenApiDocumentationTestCase
{
    #[Test]
    ...
    {
        return \sprintf('/webhooks/%s', CarrierDeliveryParser::EVENT_TYPE);
    }

    protected static function signatureHeaderName(): string
    {
        return CarrierDeliveryParser::SIGNATURE_HEADER;
    }
}
