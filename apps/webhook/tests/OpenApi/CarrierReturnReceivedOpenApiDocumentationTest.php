...
final class CarrierReturnReceivedOpenApiDocumentationTest extends AbstractWebhookOpenApiDocumentationTestCase
{
    #[Test]
    public function itDocumentsTheReturnReceptionEndpoint(): void
    {
        // Given
        ...
        self::assertSame('Report a shipment as received back by the carrier.', $operation['summary']);
    ...
    public function itReferencesThePayloadSchema(): void
    {
        ...
        self::assertSame(['$ref' => '#/components/schemas/CarrierReturnReceivedPayload'], self::toArray($schema));
    }
    ...
    public function itDocumentsPayloadFieldsWithDescriptionAndExample(): void
    {
        ...
        $schema = self::toArray($schemas['CarrierReturnReceivedPayload']);
    ...
    {
        return \sprintf('/webhooks/%s', CarrierReturnReceivedParser::EVENT_TYPE);
    }

    protected static function signatureHeaderName(): string
    {
        return CarrierReturnReceivedParser::SIGNATURE_HEADER;
    }
}
