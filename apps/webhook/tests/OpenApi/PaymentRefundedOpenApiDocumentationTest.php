...
final class PaymentRefundedOpenApiDocumentationTest extends AbstractWebhookOpenApiDocumentationTestCase
{
    #[Test]
    public function itDocumentsTheRefundConfirmationEndpoint(): void
    {
        // Given
        ...
        self::assertSame('Report an order payment refund as confirmed.', $operation['summary']);
    ...
    public function itReferencesThePayloadSchema(): void
    {
        ...
        self::assertSame(['$ref' => '#/components/schemas/PaymentRefundedPayload'], self::toArray($schema));
    }
    ...
    public function itDocumentsPayloadFieldsWithDescriptionAndExample(): void
    {
        ...
        $schema = self::toArray($schemas['PaymentRefundedPayload']);

        self::assertSame([
            'paymentReference' => [
                "The payment provider's own reference for the refunded charge.",
                'GLBX-9F3K2M1P',
            ],
    ...
    {
        return PaymentRefundedParser::SIGNATURE_HEADER;
    }
}
