...
final class PaymentFailedOpenApiDocumentationTest extends AbstractWebhookOpenApiDocumentationTestCase
{
    #[Test]
    public function itDocumentsTheFailureEndpoint(): void
    {
        // Given
        ...
        self::assertSame('Report an order payment as failed.', $operation['summary']);
    ...
    public function itReferencesThePayloadSchema(): void
    {
        ...
        self::assertSame(['$ref' => '#/components/schemas/PaymentFailedPayload'], self::toArray($schema));
    }
    ...
    public function itDocumentsPayloadFieldsWithDescriptionAndExample(): void
    {
        ...
        $schema = self::toArray($schemas['PaymentFailedPayload']);

        self::assertSame([
            'paymentReference' => [
                "The payment provider's own reference for the failed charge.",
                'GLBX-9F3K2M1P',
            ],
    ...
    {
        return PaymentFailedParser::SIGNATURE_HEADER;
    }
}
